%% Step19_Ishii_Amp_Boxplot.m
% =========================================================================
% 功能: Ishii 数据振幅箱线图 (8 阶展开项) - 增强版
% 特性: 
%   1. 同时输出 [多轴紧凑版] 和 [单轴版] 两个图
%   2. 窗口最大化，确保显示清晰
%   3. 智能单位检测
% =========================================================================
clear; clc; close all;
...
UniColor   = [0.466 0.674 0.188]; % Ishii 用统一绿色 (单轴)

BoxWidth = 0.55; ScatterWidth = 0.4; ScatterAlpha = 0.5; ScatterSize = 6; % 减小点大小

Pos_G1 = [1, 2];       % T1, T2
Pos_G2 = [3.8, 4.8, 5.8];  % T3, T4, T5
...
%% Figure 1: 3-Y 轴 (紧凑版)
%% ==========================================================
fprintf('>> 绘制 Figure 1: Ishii 多轴紧凑版...\n');
f1 = figure('Color', 'w', 'Name', 'Ishii Amp Compact', 'WindowState', 'maximized');
...
title(ax1, '\fontname{Microsoft YaHei}Ishii 各阶独立项振幅 (多轴布局)', 'FontSize', 18, 'FontWeight', 'bold');
...
% 保存
OutFile1 = fullfile(OutputDir, 'Ishii_Amp_Boxplot_MultiAxis.jpg');
exportgraphics(f1, OutFile1, 'Resolution', 300);

%% ==========================================================
%% Figure 2: 单 Y 轴 (标准版)
%% ==========================================================
fprintf('>> 绘制 Figure 2: Ishii 单轴版...\n');
f2 = figure('Color', 'w', 'Name', 'Ishii Amp Single', 'WindowState', 'maximized');
...
title('\fontname{Microsoft YaHei}Ishii 各阶独立项振幅 (单轴)', 'FontSize', 18, 'FontWeight', 'bold');
...
OutFile2 = fullfile(OutputDir, 'Ishii_Amp_Boxplot_SingleAxis.jpg');
exportgraphics(f2, OutFile2, 'Resolution', 300);
