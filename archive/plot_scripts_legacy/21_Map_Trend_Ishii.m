...
sgtitle('\fontname{Microsoft YaHei}Ishii 1-8 阶独立项趋势分布 (点区域 p < 0.05)', 'FontSize', 16, 'FontWeight', 'bold');
set(findall(gcf, '-property', 'FontName'), 'FontName', 'Times New Roman');

% 保存
OutputDir = 'D:\work\Figures';
OutFile = fullfile(OutputDir, 'Ishii_Trend_Map_8Orders_Sig.jpg');
