...
UniColor   = [0 0.447 0.741]; % 单轴用统一蓝色
...
title(ax1, '\fontname{Microsoft YaHei}IAP 各阶独立项振幅 (多轴布局)', 'FontSize', 18, 'FontWeight', 'bold');
...
% 保存
OutFile1 = fullfile(OutputDir, 'IAP_Amp_Boxplot_MultiAxis.jpg');
...
title('\fontname{Microsoft YaHei}IAP 各阶独立项振幅 (单轴)', 'FontSize', 18, 'FontWeight', 'bold');
...
OutFile2 = fullfile(OutputDir, 'IAP_Amp_Boxplot_SingleAxis.jpg');
