...
ylabel('Trend bais (mm/yr)', 'FontSize', ylabel_fontsize);
set(gca, 'XTick', box_centers_3, 'XTickLabel', categories_3, 'FontSize', tick_fontsize);
grid on;

% 添加子图标签 a)
text(0.02, 0.985, '(13) Gravitational approximation', 'Units', 'normalized', 'FontSize', 13, 'FontWeight', 'bold',  ...
...
% 添加子图标签 b)
text(0.02, 0.985, '(14) Density approximation', 'Units', 'normalized', 'FontSize', 13, 'FontWeight', 'bold',...
     'VerticalAlignment', 'top', 'HorizontalAlignment', 'left');
...
% 添加子图标签 c)
text(0.02, 0.985, '(15) Reference selection', 'Units', 'normalized', 'FontSize', 13, 'FontWeight', 'bold',...
     'VerticalAlignment', 'top', 'HorizontalAlignment', 'left');
...
% 添加子图标签 d)
text(0.02, 0.985, '(16) Low-order approximation', 'Units', 'normalized', 'FontSize', 13, 'FontWeight', 'bold',...
     'VerticalAlignment', 'top', 'HorizontalAlignment', 'left');
