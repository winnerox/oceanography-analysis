%% Calc_CrossDetail_IAP_Avg.m
% =========================================================================
% 功能：计算 IAP 的详细混合项 (Order 2-8) [平均态]
% 输出：D:\work\IAP_TSLA_Terms\IAP_CrossDetail_Avg.mat
% =========================================================================
clear; clc;

DataDir = 'D:\work\IAP_05_24';
OutputDir = 'D:\work\IAP_TSLA_Terms';
MeanFile = fullfile(OutputDir, 'IAP_Mean_State.mat');
...
SaveName = fullfile(OutputDir, 'IAP_CrossDetail_Avg.mat');
lon=Lon; lat=Lat;
