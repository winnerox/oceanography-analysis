%% Calc_Cross_Terms_IAP_Avg.m
% =========================================================================
% 功能：计算 IAP【平均态】下的混合项 (Cross Terms, 2-8阶)
% 输出：D:\work\MAT_Data\IAP_Cross_Terms_1to8_Average.mat
% 极致优化：
...
MeanStateFile = 'D:\work\IAP_TSLA_Terms\IAP_Mean_State.mat';
if ~exist(OutputDir, 'dir'), mkdir(OutputDir); end
SaveName = fullfile(OutputDir, 'IAP_Cross_Terms_1to8_Average.mat');
...
for y = Years
    for m = 1:12
        ...
        try
            ...
            disp(['IAP Cross Error at Year ' num2str(y) ' Month ' num2str(m)]);
            disp(ME.message);
