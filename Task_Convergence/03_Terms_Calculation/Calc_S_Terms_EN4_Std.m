%% Calc_S_Terms_EN4_Std.m
% =========================================================================
% 功能：计算 EN4【标准态】下的纯盐度项 (Pure S Terms, 1-8阶)
% 输出：D:\work\MAT_Data\EN4_S_Terms_1to8_StdRef.mat
% 极致优化：
...
SaveName = fullfile(OutputDir, 'EN4_S_Terms_1to8_StdRef.mat');
...
for n = 1:MaxOrder
    D_val = Engine.calculate_mixed(SA_Ref_3D, CT_Ref_3D, P_3D, 0, n);
