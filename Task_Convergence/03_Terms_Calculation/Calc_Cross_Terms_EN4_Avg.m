%% Calc_Cross_Terms_EN4_Avg.m
% =========================================================================
% 功能：计算 EN4【平均态】下的混合项 (Cross Terms, 2-8阶)
% 输出：D:\work\MAT_Data\EN4_Cross_Terms_1to8_Average.mat
% 极致优化：
...
SaveName = fullfile(OutputDir, 'EN4_Cross_Terms_1to8_Average.mat');
