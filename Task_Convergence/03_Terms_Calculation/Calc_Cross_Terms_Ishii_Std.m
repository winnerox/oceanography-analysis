%% Calc_Cross_Terms_Ishii_Std.m
% =========================================================================
% 功能：计算 Ishii【标准态】下的混合项 (Cross Terms, 2-8阶)
% 输出：D:\work\MAT_Data\Ishii_Cross_Terms_1to8_StdRef.mat
% 极致优化：
...
SaveName = fullfile(OutputDir, 'Ishii_Cross_Terms_1to8_StdRef.mat');
