...
elseif max(abs(Map_Amp(:))) < 0.5
    % 理论上不应该，但防止数据已经是 m 而未转换
end
...
sgtitle('\fontname{Microsoft YaHei}EN4 (StdRef) 1-8 阶独立项振幅空间分布', 'FontSize', 16, 'FontWeight', 'bold');
