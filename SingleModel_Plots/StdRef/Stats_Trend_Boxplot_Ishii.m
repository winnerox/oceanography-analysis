...
title(ax1, '\fontname{Microsoft YaHei}Ishii (StdRef) 各阶趋势分布图 (0轴对齐版)', 'FontSize', 16, 'FontWeight', 'bold');
...
title('\fontname{Microsoft YaHei}Ishii (StdRef) 各阶趋势分布图 (单轴)', 'FontSize', 16, 'FontWeight', 'bold');
