...
for n = 1:8
    ...
    for i=1:nlon
        for j=1:nlat
            ...
            % EN4 Average 通常输出 m，所以 * 1000 转 mm
            % 但如果数据源改了，这里要检查。假设沿用旧脚本逻辑 * 1000。
...
sgtitle('\fontname{Microsoft YaHei}EN4 (Average) 1-8 阶独立项趋势分布 (点区域 p < 0.05)', 'FontSize', 16, 'FontWeight', 'bold');
