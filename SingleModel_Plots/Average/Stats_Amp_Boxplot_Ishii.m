...
%% 1. 加载数据
files = {'Ishii_TSLA_Terms_1to8_Average.mat'};
input_file = '';
...
title(ax1, '\fontname{Microsoft YaHei}Ishii (Average) 各阶独立项振幅 (多轴布局)', 'FontSize', 18, 'FontWeight', 'bold');
...
title('\fontname{Microsoft YaHei}Ishii (Average) 各阶独立项振幅 (单轴)', 'FontSize', 18, 'FontWeight', 'bold');
