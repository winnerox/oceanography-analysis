...
% 颜色
C1 = [0.8500 0.3250 0.0980]; % 红色
C2 = [0 0.4470 0.7410];      % 蓝色
C3 = [0.4660 0.6740 0.1880]; % 绿色
...
All_Ticks = [Pos_G1, Pos_G2, Pos_G3(1:2)]; % Only T6, T7
...
title(ax1, '\fontname{Microsoft YaHei}Ishii (Average) 各阶趋势分布图 (0轴对齐版)', 'FontSize', 16, 'FontWeight', 'bold');
...
title('\fontname{Microsoft YaHei}Ishii (Average) 各阶趋势分布图 (单轴)', 'FontSize', 16, 'FontWeight', 'bold');
