...
title(ax1, '\fontname{Microsoft YaHei}EN4 (Average) 各阶独立项振幅 (多轴布局)', 'FontSize', 18, 'FontWeight', 'bold');
...
title('\fontname{Microsoft YaHei}EN4 (Average) 各阶独立项振幅 (单轴)', 'FontSize', 18, 'FontWeight', 'bold');
